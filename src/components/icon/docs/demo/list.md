...
<ul class="icon_lists clear">
        ...
        <li>
        <i class="icon ivu-icon ivu-icon-ios-recording"></i>
            <div class="name">ios-recording</div>
            <div class="fontclass">.ivu-icon-ios-recording</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-redo"></i>
            <div class="name">ios-redo</div>
            <div class="fontclass">.ivu-icon-ios-redo</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-refresh-empty"></i>
            <div class="name">ios-refresh-empty</div>
            <div class="fontclass">.ivu-icon-ios-refresh-empty</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-refresh-outline"></i>
            <div class="name">ios-refresh-outline</div>
            <div class="fontclass">.ivu-icon-ios-refresh-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-refresh"></i>
            <div class="name">ios-refresh</div>
            <div class="fontclass">.ivu-icon-ios-refresh</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-rainy"></i>
            <div class="name">ios-rainy</div>
            <div class="fontclass">.ivu-icon-ios-rainy</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-reload"></i>
            <div class="name">ios-reload</div>
            <div class="fontclass">.ivu-icon-ios-reload</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-rewind-outline"></i>
            <div class="name">ios-rewind-outline</div>
            <div class="fontclass">.ivu-icon-ios-rewind-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-reverse-camera"></i>
            <div class="name">ios-reverse-camera</div>
            <div class="fontclass">.ivu-icon-ios-reverse-camera</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-rewind"></i>
            <div class="name">ios-rewind</div>
            <div class="fontclass">.ivu-icon-ios-rewind</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-reverse-camera-o"></i>
            <div class="name">ios-reverse-camera-o</div>
            <div class="fontclass">.ivu-icon-ios-reverse-camera-o</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-search-strong"></i>
            <div class="name">ios-search-strong</div>
            <div class="fontclass">.ivu-icon-ios-search-strong</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-rose"></i>
            <div class="name">ios-rose</div>
            <div class="fontclass">.ivu-icon-ios-rose</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-search"></i>
            <div class="name">ios-search</div>
            <div class="fontclass">.ivu-icon-ios-search</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-settings-strong"></i>
            <div class="name">ios-settings-strong</div>
            <div class="fontclass">.ivu-icon-ios-settings-strong</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-rose-outline"></i>
            <div class="name">ios-rose-outline</div>
            <div class="fontclass">.ivu-icon-ios-rose-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-settings"></i>
            <div class="name">ios-settings</div>
            <div class="fontclass">.ivu-icon-ios-settings</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-skipbackward-out"></i>
            <div class="name">ios-skipbackward-out</div>
            <div class="fontclass">.ivu-icon-ios-skipbackward-out</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-shuffle-strong"></i>
            <div class="name">ios-shuffle-strong</div>
            <div class="fontclass">.ivu-icon-ios-shuffle-strong</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-shuffle"></i>
            <div class="name">ios-shuffle</div>
            <div class="fontclass">.ivu-icon-ios-shuffle</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-skipbackward"></i>
            <div class="name">ios-skipbackward</div>
            <div class="fontclass">.ivu-icon-ios-skipbackward</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-skipforward-outl"></i>
            <div class="name">ios-skipforward-outl</div>
            <div class="fontclass">.ivu-icon-ios-skipforward-outl</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-skipforward"></i>
            <div class="name">ios-skipforward</div>
            <div class="fontclass">.ivu-icon-ios-skipforward</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-snowy"></i>
            <div class="name">ios-snowy</div>
            <div class="fontclass">.ivu-icon-ios-snowy</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-star-half"></i>
            <div class="name">ios-star-half</div>
            <div class="fontclass">.ivu-icon-ios-star-half</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-star-outline"></i>
            <div class="name">ios-star-outline</div>
            <div class="fontclass">.ivu-icon-ios-star-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-star"></i>
            <div class="name">ios-star</div>
            <div class="fontclass">.ivu-icon-ios-star</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-speedometer-outl"></i>
            <div class="name">ios-speedometer-outl</div>
            <div class="fontclass">.ivu-icon-ios-speedometer-outl</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-stopwatch-outlin"></i>
            <div class="name">ios-stopwatch-outlin</div>
            <div class="fontclass">.ivu-icon-ios-stopwatch-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-stopwatch"></i>
            <div class="name">ios-stopwatch</div>
            <div class="fontclass">.ivu-icon-ios-stopwatch</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-sunny-outline"></i>
            <div class="name">ios-sunny-outline</div>
            <div class="fontclass">.ivu-icon-ios-sunny-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-speedometer"></i>
            <div class="name">ios-speedometer</div>
            <div class="fontclass">.ivu-icon-ios-speedometer</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-telephone-outlin"></i>
            <div class="name">ios-telephone-outlin</div>
            <div class="fontclass">.ivu-icon-ios-telephone-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-telephone"></i>
            <div class="name">ios-telephone</div>
            <div class="fontclass">.ivu-icon-ios-telephone</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-sunny"></i>
            <div class="name">ios-sunny</div>
            <div class="fontclass">.ivu-icon-ios-sunny</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-tennisball-outli"></i>
            <div class="name">ios-tennisball-outli</div>
            <div class="fontclass">.ivu-icon-ios-tennisball-outli</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-thunderstorm-out"></i>
            <div class="name">ios-thunderstorm-out</div>
            <div class="fontclass">.ivu-icon-ios-thunderstorm-out</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-thunderstorm"></i>
            <div class="name">ios-thunderstorm</div>
            <div class="fontclass">.ivu-icon-ios-thunderstorm</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-tennisball"></i>
            <div class="name">ios-tennisball</div>
            <div class="fontclass">.ivu-icon-ios-tennisball</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-timer-outline"></i>
            <div class="name">ios-timer-outline</div>
            <div class="fontclass">.ivu-icon-ios-timer-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-timer"></i>
            <div class="name">ios-timer</div>
            <div class="fontclass">.ivu-icon-ios-timer</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-time-outline"></i>
            <div class="name">ios-time-outline</div>
            <div class="fontclass">.ivu-icon-ios-time-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-toggle"></i>
            <div class="name">ios-toggle</div>
            <div class="fontclass">.ivu-icon-ios-toggle</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-toggle-outline"></i>
            <div class="name">ios-toggle-outline</div>
            <div class="fontclass">.ivu-icon-ios-toggle-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-time"></i>
            <div class="name">ios-time</div>
            <div class="fontclass">.ivu-icon-ios-time</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-trash-outline"></i>
            <div class="name">ios-trash-outline</div>
            <div class="fontclass">.ivu-icon-ios-trash-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-trash"></i>
            <div class="name">ios-trash</div>
            <div class="fontclass">.ivu-icon-ios-trash</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-undo-outline"></i>
            <div class="name">ios-undo-outline</div>
            <div class="fontclass">.ivu-icon-ios-undo-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-undo"></i>
            <div class="name">ios-undo</div>
            <div class="fontclass">.ivu-icon-ios-undo</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-unlocked-outline"></i>
            <div class="name">ios-unlocked-outline</div>
            <div class="fontclass">.ivu-icon-ios-unlocked-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-unlocked"></i>
            <div class="name">ios-unlocked</div>
            <div class="fontclass">.ivu-icon-ios-unlocked</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-upload-outline"></i>
            <div class="name">ios-upload-outline</div>
            <div class="fontclass">.ivu-icon-ios-upload-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-videocam-outline"></i>
            <div class="name">ios-videocam-outline</div>
            <div class="fontclass">.ivu-icon-ios-videocam-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-upload"></i>
            <div class="name">ios-upload</div>
            <div class="fontclass">.ivu-icon-ios-upload</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-videocam"></i>
            <div class="name">ios-videocam</div>
            <div class="fontclass">.ivu-icon-ios-videocam</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-volume-high"></i>
            <div class="name">ios-volume-high</div>
            <div class="fontclass">.ivu-icon-ios-volume-high</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-volume-low"></i>
            <div class="name">ios-volume-low</div>
            <div class="fontclass">.ivu-icon-ios-volume-low</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-wineglass"></i>
            <div class="name">ios-wineglass</div>
            <div class="fontclass">.ivu-icon-ios-wineglass</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-wineglass-outlin"></i>
            <div class="name">ios-wineglass-outlin</div>
            <div class="fontclass">.ivu-icon-ios-wineglass-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ipad"></i>
            <div class="name">ipad</div>
            <div class="fontclass">.ivu-icon-ipad</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-world-outline"></i>
            <div class="name">ios-world-outline</div>
            <div class="fontclass">.ivu-icon-ios-world-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-iphone"></i>
            <div class="name">iphone</div>
            <div class="fontclass">.ivu-icon-iphone</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-world"></i>
            <div class="name">ios-world</div>
            <div class="fontclass">.ivu-icon-ios-world</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ipod"></i>
            <div class="name">ipod</div>
            <div class="fontclass">.ivu-icon-ipod</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-jet"></i>
            <div class="name">jet</div>
            <div class="fontclass">.ivu-icon-jet</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-key"></i>
            <div class="name">key</div>
            <div class="fontclass">.ivu-icon-key</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-knife"></i>
            <div class="name">knife</div>
            <div class="fontclass">.ivu-icon-knife</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-laptop"></i>
            <div class="name">laptop</div>
            <div class="fontclass">.ivu-icon-laptop</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-leaf"></i>
            <div class="name">leaf</div>
            <div class="fontclass">.ivu-icon-leaf</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-levels"></i>
            <div class="name">levels</div>
            <div class="fontclass">.ivu-icon-levels</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-lightbulb"></i>
            <div class="name">lightbulb</div>
            <div class="fontclass">.ivu-icon-lightbulb</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-link"></i>
            <div class="name">link</div>
            <div class="fontclass">.ivu-icon-link</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-load-b"></i>
            <div class="name">load-b</div>
            <div class="fontclass">.ivu-icon-load-b</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-load-a"></i>
            <div class="name">load-a</div>
            <div class="fontclass">.ivu-icon-load-a</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-load-c"></i>
            <div class="name">load-c</div>
            <div class="fontclass">.ivu-icon-load-c</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-location"></i>
            <div class="name">location</div>
            <div class="fontclass">.ivu-icon-location</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-load-d"></i>
            <div class="name">load-d</div>
            <div class="fontclass">.ivu-icon-load-d</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-locked"></i>
            <div class="name">locked</div>
            <div class="fontclass">.ivu-icon-locked</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-log-in"></i>
            <div class="name">log-in</div>
            <div class="fontclass">.ivu-icon-log-in</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-loop"></i>
            <div class="name">loop</div>
            <div class="fontclass">.ivu-icon-loop</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-log-out"></i>
            <div class="name">log-out</div>
            <div class="fontclass">.ivu-icon-log-out</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-lock-combination"></i>
            <div class="name">lock-combination</div>
            <div class="fontclass">.ivu-icon-lock-combination</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-magnet"></i>
            <div class="name">magnet</div>
            <div class="fontclass">.ivu-icon-magnet</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-male"></i>
            <div class="name">male</div>
            <div class="fontclass">.ivu-icon-male</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-man"></i>
            <div class="name">man</div>
            <div class="fontclass">.ivu-icon-man</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-medkit"></i>
            <div class="name">medkit</div>
            <div class="fontclass">.ivu-icon-medkit</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-merge"></i>
            <div class="name">merge</div>
            <div class="fontclass">.ivu-icon-merge</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-mic-b"></i>
            <div class="name">mic-b</div>
            <div class="fontclass">.ivu-icon-mic-b</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-mic-c"></i>
            <div class="name">mic-c</div>
            <div class="fontclass">.ivu-icon-mic-c</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-mic-a"></i>
            <div class="name">mic-a</div>
            <div class="fontclass">.ivu-icon-mic-a</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-map"></i>
            <div class="name">map</div>
            <div class="fontclass">.ivu-icon-map</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-minus-circled"></i>
            <div class="name">minus-circled</div>
            <div class="fontclass">.ivu-icon-minus-circled</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-minus-round"></i>
            <div class="name">minus-round</div>
            <div class="fontclass">.ivu-icon-minus-round</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-more"></i>
            <div class="name">more</div>
            <div class="fontclass">.ivu-icon-more</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-monitor"></i>
            <div class="name">monitor</div>
            <div class="fontclass">.ivu-icon-monitor</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-music-note"></i>
            <div class="name">music-note</div>
            <div class="fontclass">.ivu-icon-music-note</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-model-s"></i>
            <div class="name">model-s</div>
            <div class="fontclass">.ivu-icon-model-s</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-minus"></i>
            <div class="name">minus</div>
            <div class="fontclass">.ivu-icon-minus</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-navicon-round"></i>
            <div class="name">navicon-round</div>
            <div class="fontclass">.ivu-icon-navicon-round</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-mouse"></i>
            <div class="name">mouse</div>
            <div class="fontclass">.ivu-icon-mouse</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-navicon"></i>
            <div class="name">navicon</div>
            <div class="fontclass">.ivu-icon-navicon</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-navigate"></i>
            <div class="name">navigate</div>
            <div class="fontclass">.ivu-icon-navigate</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-network"></i>
            <div class="name">network</div>
            <div class="fontclass">.ivu-icon-network</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-nuclear"></i>
            <div class="name">nuclear</div>
            <div class="fontclass">.ivu-icon-nuclear</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-outlet"></i>
            <div class="name">outlet</div>
            <div class="fontclass">.ivu-icon-outlet</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-no-smoking"></i>
            <div class="name">no-smoking</div>
            <div class="fontclass">.ivu-icon-no-smoking</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-paintbucket"></i>
            <div class="name">paintbucket</div>
            <div class="fontclass">.ivu-icon-paintbucket</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-paper-airplane"></i>
            <div class="name">paper-airplane</div>
            <div class="fontclass">.ivu-icon-paper-airplane</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-paintbrush"></i>
            <div class="name">paintbrush</div>
            <div class="fontclass">.ivu-icon-paintbrush</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-paperclip"></i>
            <div class="name">paperclip</div>
            <div class="fontclass">.ivu-icon-paperclip</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-pause"></i>
            <div class="name">pause</div>
            <div class="fontclass">.ivu-icon-pause</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-person-add"></i>
            <div class="name">person-add</div>
            <div class="fontclass">.ivu-icon-person-add</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-person-stalker"></i>
            <div class="name">person-stalker</div>
            <div class="fontclass">.ivu-icon-person-stalker</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-pie-graph"></i>
            <div class="name">pie-graph</div>
            <div class="fontclass">.ivu-icon-pie-graph</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-pin"></i>
            <div class="name">pin</div>
            <div class="fontclass">.ivu-icon-pin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-person"></i>
            <div class="name">person</div>
            <div class="fontclass">.ivu-icon-person</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-pinpoint"></i>
            <div class="name">pinpoint</div>
            <div class="fontclass">.ivu-icon-pinpoint</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-plane"></i>
            <div class="name">plane</div>
            <div class="fontclass">.ivu-icon-plane</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-play"></i>
            <div class="name">play</div>
            <div class="fontclass">.ivu-icon-play</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-plus-circled"></i>
            <div class="name">plus-circled</div>
            <div class="fontclass">.ivu-icon-plus-circled</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-pizza"></i>
            <div class="name">pizza</div>
            <div class="fontclass">.ivu-icon-pizza</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-playstation"></i>
            <div class="name">playstation</div>
            <div class="fontclass">.ivu-icon-playstation</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-planet"></i>
            <div class="name">planet</div>
            <div class="fontclass">.ivu-icon-planet</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-plus-round"></i>
            <div class="name">plus-round</div>
            <div class="fontclass">.ivu-icon-plus-round</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-plus"></i>
            <div class="name">plus</div>
            <div class="fontclass">.ivu-icon-plus</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-podium"></i>
            <div class="name">podium</div>
            <div class="fontclass">.ivu-icon-podium</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-pound"></i>
            <div class="name">pound</div>
            <div class="fontclass">.ivu-icon-pound</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-power"></i>
            <div class="name">power</div>
            <div class="fontclass">.ivu-icon-power</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-pricetag"></i>
            <div class="name">pricetag</div>
            <div class="fontclass">.ivu-icon-pricetag</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-pricetags"></i>
            <div class="name">pricetags</div>
            <div class="fontclass">.ivu-icon-pricetags</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-printer"></i>
            <div class="name">printer</div>
            <div class="fontclass">.ivu-icon-printer</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-qr-scanner"></i>
            <div class="name">qr-scanner</div>
            <div class="fontclass">.ivu-icon-qr-scanner</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-quote"></i>
            <div class="name">quote</div>
            <div class="fontclass">.ivu-icon-quote</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-pull-request"></i>
            <div class="name">pull-request</div>
            <div class="fontclass">.ivu-icon-pull-request</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-record"></i>
            <div class="name">record</div>
            <div class="fontclass">.ivu-icon-record</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-refresh"></i>
            <div class="name">refresh</div>
            <div class="fontclass">.ivu-icon-refresh</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-reply-all"></i>
            <div class="name">reply-all</div>
            <div class="fontclass">.ivu-icon-reply-all</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-reply"></i>
            <div class="name">reply</div>
            <div class="fontclass">.ivu-icon-reply</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ribbon-a"></i>
            <div class="name">ribbon-a</div>
            <div class="fontclass">.ivu-icon-ribbon-a</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-radio-waves"></i>
            <div class="name">radio-waves</div>
            <div class="fontclass">.ivu-icon-radio-waves</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-search"></i>
            <div class="name">search</div>
            <div class="fontclass">.ivu-icon-search</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ribbon-b"></i>
            <div class="name">ribbon-b</div>
            <div class="fontclass">.ivu-icon-ribbon-b</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-sad"></i>
            <div class="name">sad</div>
            <div class="fontclass">.ivu-icon-sad</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-scissors"></i>
            <div class="name">scissors</div>
            <div class="fontclass">.ivu-icon-scissors</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-sad-outline"></i>
            <div class="name">sad-outline</div>
            <div class="fontclass">.ivu-icon-sad-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-settings"></i>
            <div class="name">settings</div>
            <div class="fontclass">.ivu-icon-settings</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-share"></i>
            <div class="name">share</div>
            <div class="fontclass">.ivu-icon-share</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-shuffle"></i>
            <div class="name">shuffle</div>
            <div class="fontclass">.ivu-icon-shuffle</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-skip-backward"></i>
            <div class="name">skip-backward</div>
            <div class="fontclass">.ivu-icon-skip-backward</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-skip-forward"></i>
            <div class="name">skip-forward</div>
            <div class="fontclass">.ivu-icon-skip-forward</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-android"></i>
            <div class="name">social-android</div>
            <div class="fontclass">.ivu-icon-social-android</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-android-outli"></i>
            <div class="name">social-android-outli</div>
            <div class="fontclass">.ivu-icon-social-android-outli</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-angular"></i>
            <div class="name">social-angular</div>
            <div class="fontclass">.ivu-icon-social-angular</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-angular-outli"></i>
            <div class="name">social-angular-outli</div>
            <div class="fontclass">.ivu-icon-social-angular-outli</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-apple-outline"></i>
            <div class="name">social-apple-outline</div>
            <div class="fontclass">.ivu-icon-social-apple-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-apple"></i>
            <div class="name">social-apple</div>
            <div class="fontclass">.ivu-icon-social-apple</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-bitcoin"></i>
            <div class="name">social-bitcoin</div>
            <div class="fontclass">.ivu-icon-social-bitcoin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-buffer"></i>
            <div class="name">social-buffer</div>
            <div class="fontclass">.ivu-icon-social-buffer</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-bitcoin-outli"></i>
            <div class="name">social-bitcoin-outli</div>
            <div class="fontclass">.ivu-icon-social-bitcoin-outli</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-chrome-outlin"></i>
            <div class="name">social-chrome-outlin</div>
            <div class="fontclass">.ivu-icon-social-chrome-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-buffer-outlin"></i>
            <div class="name">social-buffer-outlin</div>
            <div class="fontclass">.ivu-icon-social-buffer-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-chrome"></i>
            <div class="name">social-chrome</div>
            <div class="fontclass">.ivu-icon-social-chrome</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-css-outline"></i>
            <div class="name">social-css3-outline</div>
            <div class="fontclass">.ivu-icon-social-css-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-css"></i>
            <div class="name">social-css3</div>
            <div class="fontclass">.ivu-icon-social-css</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-codepen-outli"></i>
            <div class="name">social-codepen-outli</div>
            <div class="fontclass">.ivu-icon-social-codepen-outli</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-codepen"></i>
            <div class="name">social-codepen</div>
            <div class="fontclass">.ivu-icon-social-codepen</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-designernews-"></i>
            <div class="name">social-designernews-</div>
            <div class="fontclass">.ivu-icon-social-designernews-</div>
        </li>
        ...
        <li>
        <i class="icon ivu-icon ivu-icon-social-dribbble-outl"></i>
            <div class="name">social-dribbble-outl</div>
            <div class="fontclass">.ivu-icon-social-dribbble-outl</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-dropbox-outli"></i>
            <div class="name">social-dropbox-outli</div>
            <div class="fontclass">.ivu-icon-social-dropbox-outli</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-dropbox"></i>
            <div class="name">social-dropbox</div>
            <div class="fontclass">.ivu-icon-social-dropbox</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-dribbble"></i>
            <div class="name">social-dribbble</div>
            <div class="fontclass">.ivu-icon-social-dribbble</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-euro-outline"></i>
            <div class="name">social-euro-outline</div>
            <div class="fontclass">.ivu-icon-social-euro-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-facebook-outl"></i>
            <div class="name">social-facebook-outl</div>
            <div class="fontclass">.ivu-icon-social-facebook-outl</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-euro"></i>
            <div class="name">social-euro</div>
            <div class="fontclass">.ivu-icon-social-euro</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-facebook"></i>
            <div class="name">social-facebook</div>
            <div class="fontclass">.ivu-icon-social-facebook</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-foursquare"></i>
            <div class="name">social-foursquare</div>
            <div class="fontclass">.ivu-icon-social-foursquare</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-github"></i>
            <div class="name">social-github</div>
            <div class="fontclass">.ivu-icon-social-github</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-freebsd-devil"></i>
            <div class="name">social-freebsd-devil</div>
            <div class="fontclass">.ivu-icon-social-freebsd-devil</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-foursquare-ou"></i>
            <div class="name">social-foursquare-ou</div>
            <div class="fontclass">.ivu-icon-social-foursquare-ou</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-github-outlin"></i>
            <div class="name">social-github-outlin</div>
            <div class="fontclass">.ivu-icon-social-github-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-google-outlin"></i>
            <div class="name">social-google-outlin</div>
            <div class="fontclass">.ivu-icon-social-google-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-googleplus-ou"></i>
            <div class="name">social-googleplus-ou</div>
            <div class="fontclass">.ivu-icon-social-googleplus-ou</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-hackernews-ou"></i>
            <div class="name">social-hackernews-ou</div>
            <div class="fontclass">.ivu-icon-social-hackernews-ou</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-hackernews"></i>
            <div class="name">social-hackernews</div>
            <div class="fontclass">.ivu-icon-social-hackernews</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-google"></i>
            <div class="name">social-google</div>
            <div class="fontclass">.ivu-icon-social-google</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-html-outline"></i>
            <div class="name">social-html5-outline</div>
            <div class="fontclass">.ivu-icon-social-html-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-html"></i>
            <div class="name">social-html5</div>
            <div class="fontclass">.ivu-icon-social-html</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-googleplus"></i>
            <div class="name">social-googleplus</div>
            <div class="fontclass">.ivu-icon-social-googleplus</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-instagram-out"></i>
            <div class="name">social-instagram-out</div>
            <div class="fontclass">.ivu-icon-social-instagram-out</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-instagram"></i>
            <div class="name">social-instagram</div>
            <div class="fontclass">.ivu-icon-social-instagram</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-linkedin"></i>
            <div class="name">social-linkedin</div>
            <div class="fontclass">.ivu-icon-social-linkedin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-javascript"></i>
            <div class="name">social-javascript</div>
            <div class="fontclass">.ivu-icon-social-javascript</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-linkedin-outl"></i>
            <div class="name">social-linkedin-outl</div>
            <div class="fontclass">.ivu-icon-social-linkedin-outl</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-javascript-ou"></i>
            <div class="name">social-javascript-ou</div>
            <div class="fontclass">.ivu-icon-social-javascript-ou</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-markdown"></i>
            <div class="name">social-markdown</div>
            <div class="fontclass">.ivu-icon-social-markdown</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-pinterest-out"></i>
            <div class="name">social-pinterest-out</div>
            <div class="fontclass">.ivu-icon-social-pinterest-out</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-pinterest"></i>
            <div class="name">social-pinterest</div>
            <div class="fontclass">.ivu-icon-social-pinterest</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-python"></i>
            <div class="name">social-python</div>
            <div class="fontclass">.ivu-icon-social-python</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-octocat"></i>
            <div class="name">social-octocat</div>
            <div class="fontclass">.ivu-icon-social-octocat</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-nodejs"></i>
            <div class="name">social-nodejs</div>
            <div class="fontclass">.ivu-icon-social-nodejs</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-rss-outline"></i>
            <div class="name">social-rss-outline</div>
            <div class="fontclass">.ivu-icon-social-rss-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-reddit-outlin"></i>
            <div class="name">social-reddit-outlin</div>
            <div class="fontclass">.ivu-icon-social-reddit-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-reddit"></i>
            <div class="name">social-reddit</div>
            <div class="fontclass">.ivu-icon-social-reddit</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-rss"></i>
            <div class="name">social-rss</div>
            <div class="fontclass">.ivu-icon-social-rss</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-skype-outline"></i>
            <div class="name">social-skype-outline</div>
            <div class="fontclass">.ivu-icon-social-skype-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-skype"></i>
            <div class="name">social-skype</div>
            <div class="fontclass">.ivu-icon-social-skype</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-sass"></i>
            <div class="name">social-sass</div>
            <div class="fontclass">.ivu-icon-social-sass</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-tumblr-outlin"></i>
            <div class="name">social-tumblr-outlin</div>
            <div class="fontclass">.ivu-icon-social-tumblr-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-snapchat"></i>
            <div class="name">social-snapchat</div>
            <div class="fontclass">.ivu-icon-social-snapchat</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-tumblr"></i>
            <div class="name">social-tumblr</div>
            <div class="fontclass">.ivu-icon-social-tumblr</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-twitch"></i>
            <div class="name">social-twitch</div>
            <div class="fontclass">.ivu-icon-social-twitch</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-snapchat-outl"></i>
            <div class="name">social-snapchat-outl</div>
            <div class="fontclass">.ivu-icon-social-snapchat-outl</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-twitch-outlin"></i>
            <div class="name">social-twitch-outlin</div>
            <div class="fontclass">.ivu-icon-social-twitch-outlin</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-twitter-outli"></i>
            <div class="name">social-twitter-outli</div>
            <div class="fontclass">.ivu-icon-social-twitter-outli</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-twitter"></i>
            <div class="name">social-twitter</div>
            <div class="fontclass">.ivu-icon-social-twitter</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-vimeo"></i>
            <div class="name">social-vimeo</div>
            <div class="fontclass">.ivu-icon-social-vimeo</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-vimeo-outline"></i>
            <div class="name">social-vimeo-outline</div>
            <div class="fontclass">.ivu-icon-social-vimeo-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-tux"></i>
            <div class="name">social-tux</div>
            <div class="fontclass">.ivu-icon-social-tux</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-usd"></i>
            <div class="name">social-usd</div>
            <div class="fontclass">.ivu-icon-social-usd</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-usd-outline"></i>
            <div class="name">social-usd-outline</div>
            <div class="fontclass">.ivu-icon-social-usd-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-windows-outli"></i>
            <div class="name">social-windows-outli</div>
            <div class="fontclass">.ivu-icon-social-windows-outli</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-windows"></i>
            <div class="name">social-windows</div>
            <div class="fontclass">.ivu-icon-social-windows</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-whatsapp"></i>
            <div class="name">social-whatsapp</div>
            <div class="fontclass">.ivu-icon-social-whatsapp</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-wordpress-out"></i>
            <div class="name">social-wordpress-out</div>
            <div class="fontclass">.ivu-icon-social-wordpress-out</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-whatsapp-outl"></i>
            <div class="name">social-whatsapp-outl</div>
            <div class="fontclass">.ivu-icon-social-whatsapp-outl</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-yahoo-outline"></i>
            <div class="name">social-yahoo-outline</div>
            <div class="fontclass">.ivu-icon-social-yahoo-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-yahoo"></i>
            <div class="name">social-yahoo</div>
            <div class="fontclass">.ivu-icon-social-yahoo</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-wordpress"></i>
            <div class="name">social-wordpress</div>
            <div class="fontclass">.ivu-icon-social-wordpress</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-yen-outline"></i>
            <div class="name">social-yen-outline</div>
            <div class="fontclass">.ivu-icon-social-yen-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-yen"></i>
            <div class="name">social-yen</div>
            <div class="fontclass">.ivu-icon-social-yen</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-youtube"></i>
            <div class="name">social-youtube</div>
            <div class="fontclass">.ivu-icon-social-youtube</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-social-youtube-outli"></i>
            <div class="name">social-youtube-outli</div>
            <div class="fontclass">.ivu-icon-social-youtube-outli</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-soup-can"></i>
            <div class="name">soup-can</div>
            <div class="fontclass">.ivu-icon-soup-can</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-soup-can-outline"></i>
            <div class="name">soup-can-outline</div>
            <div class="fontclass">.ivu-icon-soup-can-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-spoon"></i>
            <div class="name">spoon</div>
            <div class="fontclass">.ivu-icon-spoon</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-speakerphone"></i>
            <div class="name">speakerphone</div>
            <div class="fontclass">.ivu-icon-speakerphone</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-star"></i>
            <div class="name">star</div>
            <div class="fontclass">.ivu-icon-star</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-speedometer"></i>
            <div class="name">speedometer</div>
            <div class="fontclass">.ivu-icon-speedometer</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-stats-bars"></i>
            <div class="name">stats-bars</div>
            <div class="fontclass">.ivu-icon-stats-bars</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-stop"></i>
            <div class="name">stop</div>
            <div class="fontclass">.ivu-icon-stop</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-thermometer"></i>
            <div class="name">thermometer</div>
            <div class="fontclass">.ivu-icon-thermometer</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-thumbsdown"></i>
            <div class="name">thumbsdown</div>
            <div class="fontclass">.ivu-icon-thumbsdown</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-steam"></i>
            <div class="name">steam</div>
            <div class="fontclass">.ivu-icon-steam</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-toggle-filled"></i>
            <div class="name">toggle-filled</div>
            <div class="fontclass">.ivu-icon-toggle-filled</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-thumbsup"></i>
            <div class="name">thumbsup</div>
            <div class="fontclass">.ivu-icon-thumbsup</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-toggle"></i>
            <div class="name">toggle</div>
            <div class="fontclass">.ivu-icon-toggle</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-transgender"></i>
            <div class="name">transgender</div>
            <div class="fontclass">.ivu-icon-transgender</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-trash-a"></i>
            <div class="name">trash-a</div>
            <div class="fontclass">.ivu-icon-trash-a</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-trash-b"></i>
            <div class="name">trash-b</div>
            <div class="fontclass">.ivu-icon-trash-b</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-tshirt-outline"></i>
            <div class="name">tshirt-outline</div>
            <div class="fontclass">.ivu-icon-tshirt-outline</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-trophy"></i>
            <div class="name">trophy</div>
            <div class="fontclass">.ivu-icon-trophy</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-tshirt"></i>
            <div class="name">tshirt</div>
            <div class="fontclass">.ivu-icon-tshirt</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-unlocked"></i>
            <div class="name">unlocked</div>
            <div class="fontclass">.ivu-icon-unlocked</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-umbrella"></i>
            <div class="name">umbrella</div>
            <div class="fontclass">.ivu-icon-umbrella</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-university"></i>
            <div class="name">university</div>
            <div class="fontclass">.ivu-icon-university</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-upload"></i>
            <div class="name">upload</div>
            <div class="fontclass">.ivu-icon-upload</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-usb"></i>
            <div class="name">usb</div>
            <div class="fontclass">.ivu-icon-usb</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-videocamera"></i>
            <div class="name">videocamera</div>
            <div class="fontclass">.ivu-icon-videocamera</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-volume-medium"></i>
            <div class="name">volume-medium</div>
            <div class="fontclass">.ivu-icon-volume-medium</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-volume-low"></i>
            <div class="name">volume-low</div>
            <div class="fontclass">.ivu-icon-volume-low</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-volume-high"></i>
            <div class="name">volume-high</div>
            <div class="fontclass">.ivu-icon-volume-high</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-waterdrop"></i>
            <div class="name">waterdrop</div>
            <div class="fontclass">.ivu-icon-waterdrop</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-wifi"></i>
            <div class="name">wifi</div>
            <div class="fontclass">.ivu-icon-wifi</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-woman"></i>
            <div class="name">woman</div>
            <div class="fontclass">.ivu-icon-woman</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-wand"></i>
            <div class="name">wand</div>
            <div class="fontclass">.ivu-icon-wand</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-wineglass"></i>
            <div class="name">wineglass</div>
            <div class="fontclass">.ivu-icon-wineglass</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-volume-mute"></i>
            <div class="name">volume-mute</div>
            <div class="fontclass">.ivu-icon-volume-mute</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-wrench"></i>
            <div class="name">wrench</div>
            <div class="fontclass">.ivu-icon-wrench</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-xbox"></i>
            <div class="name">xbox</div>
            <div class="fontclass">.ivu-icon-xbox</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-b-arrow-left"></i>
            <div class="name">ios-b-arrow-left</div>
            <div class="fontclass">.ivu-icon-ios-b-arrow-left</div>
        </li>

        <li>
        <i class="icon ivu-icon ivu-icon-ios-b-arrow-right"></i>
            <div class="name">ios-b-arrow-left</div>
            <div class="fontclass">.ivu-icon-ios-b-arrow-right</div>
        </li>
