            ...
            <span class="el-date-range-picker__editors-wrap is-right">
              ...
              <span class="el-date-range-picker__time-picker-wrap" v-clickoutside="() => maxTimePickerVisible = false">
                <el-input
                  ...
                  :readonly="!minDate"
                  @on-change.native="handleTimeChange($event, 'max')" />
                <time-picker
                  ref="maxTimePicker"
...
<script type="text/babel">
  ...
  export default {
    ...
    computed: {
      ...
      leftLabel() {
        return this.leftDate.getFullYear() + ' ' + this.t('i.datepicker.year') + ' ' + this.t(`i.datepicker.month${ this.leftDate.getMonth() + 1 }`);
      },

      rightLabel() {
        return this.rightDate.getFullYear() + ' ' + this.t('i.datepicker.year') + ' ' + this.t(`i.datepicker.month${ this.rightDate.getMonth() + 1 }`);
      },
